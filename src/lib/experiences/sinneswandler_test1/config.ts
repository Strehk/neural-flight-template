...
export const BAT_BIOME_ORDER: readonly BatBiomeId[] = [
  "forest",
  "grassland",
  "mountains",
  "snow",
...
export const BAT_EXPERIENCE_ID = "sinneswandler_test1";
export const BAT_EXPERIENCE_NAME = "Sinneswandler Test 1";
export const BAT_EXPERIENCE_DESCRIPTION =
  "Navigate an endless nocturnal landscape where mountains, forests, snowfields, and deserts surface only when your echo reaches them.";
