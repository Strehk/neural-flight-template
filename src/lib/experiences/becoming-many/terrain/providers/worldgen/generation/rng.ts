 ...
 * randomness are used:
 *   - Sequential PRNG streams (mulberry32) for ordered algorithms like WFC and
 *     river-source selection.
 *   - Stateless coordinate hashes (hash2D) for per-position jitter that must be
 *     identical no matter which chunk/region evaluates it — this is what keeps
 *     chunk borders seamless.
 */
