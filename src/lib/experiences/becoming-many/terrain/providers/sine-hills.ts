...
//
// The default rolling-hills field (layered sines). Cheap and seed-free in
// character; `seed` phase-shifts the field, `amplitude` scales it. (frequency /
// octaves are ignored — see ridged for those.) Pure math → runs in the worker.
