...
//
// The second shipped algorithm, to prove the provider seam: a domain-warped,
// multi-octave RIDGED field (sharp crests via 1 - |sin·cos|), visibly distinct
// from sineHills' rolling hills. `octaves` adds finer ridges, `frequency` scales
// feature size, `amplitude` the height, `seed` offsets. Pure math → runs in the
// worker.
