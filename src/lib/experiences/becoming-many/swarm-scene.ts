// ── Becoming Many — WebGPU + TSL Compute Swarm (REFERENCE) ─────
//
// NOTE: This is no longer the loaded scene — `scene.ts` is (the static TSL
// terrain preview). This file is kept as the canonical, working **GPU compute**
// reference for the repo (AGENTS.md "WebGPU + TSL" points here). The moth swarm
// in M5 will be modelled on it. It is intentionally not imported anywhere.
//
